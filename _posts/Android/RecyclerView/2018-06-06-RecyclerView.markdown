...
[MaterialDesign--(2)让我欢喜让我忧的 RecyclerView - 简书](https://www.jianshu.com/p/05e9b3bb7876)

### ItemDecoration

[RecyclerView系列二：RecyclerView.ItemDecoration的详解使用 - 简书](https://www.jianshu.com/p/41ae13016243)

[RecyclerView（2）-自定义Decoration打造时光轴效果 - 简书](https://www.jianshu.com/p/7924623d87ee)
...
[MultiType-Adapter 优雅的实现RecyclerVIew中的复杂布局 - 简书](https://www.jianshu.com/p/032a6773620b)

[RecyclerView实现复杂页面](https://mp.weixin.qq.com/s/GY_VkEnX8SMZTHl-CSUk4Q)

[RecyclerView实现多type页面 - 简书](https://www.jianshu.com/p/4e12e69f02f6)

[MultiType显示多种数据类型](https://mp.weixin.qq.com/s/2sl-FzNXsG6Gd7xtazI9ag)

[RecyclerView加载多类型item 实现淘宝首页布局_Android-CSDN博客](https://blog.csdn.net/a466302603/article/details/78411612)

[Android recyclerView 实现复杂的item布局（如淘宝、京东、商城类首页）_吕氏春秋i-CSDN博客](https://blog.csdn.net/Life_s/article/details/81298823)

[Android 复杂的多类型列表视图新写法：MultiType 3.0_hyb1234hi的专栏-CSDN博客](https://blog.csdn.net/hyb1234hi/article/details/78049460?utm_source=blogxgwz2)

[MultiType-Adapter 优雅的实现RecyclerVIew中的复杂布局 - 简书](https://www.jianshu.com/p/032a6773620b)

[RecycleView进阶：使用GridLayoutManager.SpanSizeLookup来动态实现具有不同尺寸的Item_长安~郭子轩-CSDN博客](https://blog.csdn.net/gpf1320253667/article/details/84500785)

[LidongWen/MultiTypeAdapter: 多类型 recyclerAdapter](https://github.com/LidongWen/MultiTypeAdapter)

[是时候提高你撸RecycleView的效率了](https://mp.weixin.qq.com/s/rH9oS2-P09hcCj04ps46PQ)

### Click 事件

[RecyclerView添加点击事件_风轻云喏-CSDN博客](https://blog.csdn.net/a550508153/article/details/77962430)
...
[RecyclerView实现带有头部的顶部悬浮置顶布局_byd666的博客-CSDN博客_recyclerview悬浮置顶](https://blog.csdn.net/bydbbb/article/details/78709732)
...
[Android 支持刷新、加载更多、带反弹效果的RecyclerView](https://mp.weixin.qq.com/s/RKCyvAw6LCoCFePlZV1tqQ)

### 侧滑

[yanzhenjie/SwipeRecyclerView: RecyclerView侧滑菜单，Item拖拽，滑动删除Item，自动加载更多，HeaderView，FooterView，Item分组黏贴。](https://github.com/yanzhenjie/SwipeRecyclerView)

[Android 基于RecyclerView的Item侧滑删除 - 简书](https://www.jianshu.com/p/9bfed6e127cc)

[RecyclerView更全解析之 - 仿支付宝侧滑删除和拖动排序 - 简书](https://www.jianshu.com/p/8e63a4b2a50c)

### 动画

[这可能是你见过的迄今为止最简单的RecyclerView Item加载动画](https://mp.weixin.qq.com/s/plpNw9R7riN5Fp_9M2k82A)

### 双列表

[如何优雅地实现RecyclerView Adapter多布局列表 - 简书](https://www.jianshu.com/p/0118ac1584c7)

[SlideLayout 双列表页面实现](https://juejin.cn/post/6844903904052789256)

[RecyclerView双列表联动](https://mp.weixin.qq.com/s/RXzL8XQKVmq6FUJnsSOPhw)

### 其他

[加载时展示闪光效果_sharish/ShimmerRecyclerView](https://github.com/sharish/ShimmerRecyclerView?utm_source=gank.io&utm_medium=email)

[RecyclerView 的曝光统计](https://mp.weixin.qq.com/s/esqAFOpFstym2pnhLXqNXA)

[Android 仿京东,淘宝RecyclerView嵌套ViewPager嵌套RecyclerView商品展示 - 简书](https://www.jianshu.com/p/a5100ac471ae)

---------------

[抽丝剥茧RecyclerView，这篇干货岂能错过？](https://mp.weixin.qq.com/s/aYh12WSGBgHPL2dYQtKm2w)
