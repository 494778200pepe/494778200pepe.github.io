...
* 4、在 module 的 build.gradle 文件中，第一行 `apply plugin: 'com.android.library'`，那么这个 [`com.android.application` 又是什么呢？](https://494778200pepe.github.io/android/2019/07/19/Gradle-Groovy.html)
