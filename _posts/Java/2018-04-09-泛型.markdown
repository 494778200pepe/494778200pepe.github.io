...
* 所以可以用Object类型来获取值。如for(Object obj: lists)，这是合法的。
...
* 这里就又有个问题要注意了，如果我们希望在List<？exends Shape> shapes中加入一个矩形对象，
...
* 因此考虑如下代码，虽然`ArrayList<String>和ArrayList<Integer>`类型参数不同，
...
http://www.cnblogs.com/friends-wf/p/3582841.html

《站在巨著之上谈泛型》系列内容公告 – 金丝燕网
http://swiftlet.net/archives/1964

Java泛型让声明方法返回子类型 – 编码人生
http://codelife.me/blog/2014/03/05/returning-subtype-of-declared-type-from-method-by-java-generics/?utm_source=tuicool&utm_medium=referral